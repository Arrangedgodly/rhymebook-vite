...
const SettingsProfile = ({ activeTab, handleProfileTabClick }: SettingsProfileProps) => {
  return (
    <div className="collapse md:w-1/2 w-4/5 bg-secondary text-secondary-content">
      ...
      <div className={activeTab === 'profile' ? 'collapse-content transition-all' : 'hidden transition-all'}>
